	...
	exports.Layer = (function(superClass) {
	  ...
	  Layer.define("image", {
	    ...
	    set: function(value) {
	      ...
	      if (_.endsWith(typeof value.toLowerCase === "function" ? value.toLowerCase() : void 0, ".pdf") && !(Utils.isSafari() || Utils.isFramerStudio())) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	ErrorDisplay = (function(superClass) {
	  ...
	  ErrorDisplay.prototype.createLayer = function() {
	    ...
	    this._context.run((function(_this) {
	      return function() {
	        ...
	        return _this._errorLayer = error;
	      };
	    })(this));
	    return this._errorLayer;
	  };
	  ...
	  ErrorDisplay.prototype.resize = function() {
	    ...
	    this._errorLayer.width = Screen.width;
	    this._errorLayer.y = Align.bottom;
	  ...
	  ErrorDisplay.prototype.showError = function(message) {
	    ...
	    return error.text.html = message;
	  };
...
/***/ function(module, exports) {
	...
	exports.date = 1462894855;
	
	exports.branch = "master";
	
	exports.hash = "7d32c8d";
